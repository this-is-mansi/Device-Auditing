...
<html lang="en" dir="ltr">
	<head> 
		<meta charset="utf-8">
		<title>Mahametro Audited report</title>
		  <!-- Bootstrap CSS -->
...
<center>
  ...
  Audit Report
	...
	<div>
	<br>
	This certification affirms that the listed assets have been Auditted during the audit process.
	</div>
	...
	<br>
		...
		">
			...
			<tr style="background-color:lightgrey; color:black">
				...
				<td style="border:1px solid  grey; padding:10px">Scanned Asset Tag</td>
				<td style="border:1px solid  grey; padding:10px">Status</td>
			...
			$i = 1;
			$resultValue="";
			$rows = mysqli_query($conn, "SELECT * FROM backup_table WHERE status = 'audited';
            ");
			foreach($rows as $row) :
			...
			<tr id="<?php echo $row["asset_tag"]; ?>">
				...
				<td style="border:1px solid lightgrey; padding:10px;"> <?php echo $row["obt_tag"]; ?> </td>
				<td style="border:1px solid lightgrey; padding:10px;"> <?php echo $row["status"]; ?> </td>
			    <td  style="border:1px solid lightgrey; padding:10px;"><?php echo $row["AuditOn"]; ?> </td>
			</tr>
			<?php endforeach; ?>
		</table>
    </center>
